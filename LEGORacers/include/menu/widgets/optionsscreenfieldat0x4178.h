...
// SIZE 0x6dc
class OptionsScreenFieldAt0x4178Base0x6dc : public ObscureBanner0x5ec {
public:
	OptionsScreenFieldAt0x4178Base0x6dc();
	void Reset() override;                                                                    // vtable+0x00
	~OptionsScreenFieldAt0x4178Base0x6dc() override;                                          // vtable+0x04
...
protected:
	...
	undefined m_unk0x6d0[0x6dc - 0x6d0]; // 0x6d0
};

// VTABLE: LEGORACERS 0x004b25a8
// SIZE 0x6ec
class OptionsScreenFieldAt0x4178 : public OptionsScreenFieldAt0x4178Base0x6dc {
public:
